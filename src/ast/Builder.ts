...
class Builder extends BaseBuilder {
  ...
  bit(data: {
    ...
    const node: Bit = {
      ...
      padletId: this.toAstProperty(PropertyConfigKey._padletId, padletId),
      aiGenerated: this.toAstProperty(PropertyConfigKey._aiGenerated, aiGenerated),
      releaseVersion: this.toAstProperty(PropertyConfigKey._releaseVersion, releaseVersion),
      book,
      ageRange: this.toAstProperty(PropertyConfigKey._ageRange, ageRange),
      language: this.toAstProperty(PropertyConfigKey._language, language),
      computerLanguage: this.toAstProperty(PropertyConfigKey._computerLanguage, computerLanguage),
      target: this.toAstProperty(PropertyConfigKey._target, target),
      tag: this.toAstProperty(PropertyConfigKey._tag, tag),
      icon: this.toAstProperty(PropertyConfigKey._icon, icon),
      iconTag: this.toAstProperty(PropertyConfigKey._iconTag, iconTag),
      colorTag: this.toAstProperty(PropertyConfigKey._colorTag, colorTag),
      flashcardSet: this.toAstProperty(PropertyConfigKey._flashcardSet, flashcardSet),
      subtype: this.toAstProperty(PropertyConfigKey._subtype, subtype),
      coverImage: this.toAstProperty(PropertyConfigKey._coverImage, coverImage),
      publisher: this.toAstProperty(PropertyConfigKey._publisher, publisher),
      publications: this.toAstProperty(PropertyConfigKey._publications, publications),
      author: this.toAstProperty(PropertyConfigKey._author, author),
      subject: this.toAstProperty(PropertyConfigKey._subject, subject),
      date: this.toAstProperty(PropertyConfigKey._date, date),
      location: this.toAstProperty(PropertyConfigKey._location, location),
      theme: this.toAstProperty(PropertyConfigKey._theme, theme),
      kind: this.toAstProperty(PropertyConfigKey._kind, kind),
      action: this.toAstProperty(PropertyConfigKey._action, action),
      thumbImage: this.toAstProperty(PropertyConfigKey._thumbImage, thumbImage),
      focusX: this.toAstProperty(PropertyConfigKey._focusX, focusX),
      focusY: this.toAstProperty(PropertyConfigKey._focusY, focusY),
      deeplink: this.toAstProperty(PropertyConfigKey._deeplink, deeplink),
      externalLink: this.toAstProperty(PropertyConfigKey._externalLink, externalLink),
      externalLinkText: this.toAstProperty(PropertyConfigKey._externalLinkText, externalLinkText),
      videoCallLink: this.toAstProperty(PropertyConfigKey._videoCallLink, videoCallLink),
      bot: this.toAstProperty(PropertyConfigKey._bot, bot),
      duration: this.toAstProperty(PropertyConfigKey._duration, duration),
      referenceProperty: this.toAstProperty(PropertyConfigKey._reference, referenceProperty),
      list: this.toAstProperty(PropertyConfigKey._list, list),
      textReference: this.toAstProperty(PropertyConfigKey._textReference, textReference),
      isTracked: this.toAstProperty(PropertyConfigKey._isTracked, isTracked),
      isInfoOnly: this.toAstProperty(PropertyConfigKey._isInfoOnly, isInfoOnly),
      labelTrue: this.toAstProperty(PropertyConfigKey._labelTrue, labelTrue),
      labelFalse: this.toAstProperty(PropertyConfigKey._labelFalse, labelFalse),
      quotedPerson: this.toAstProperty(PropertyConfigKey._quotedPerson, quotedPerson),
      partialAnswer: this.toAstProperty(PropertyConfigKey._partialAnswer, partialAnswer),
      levelProperty: this.toAstProperty(PropertyConfigKey._level, levelProperty),
      title,
      subtitle,
      level: NumberUtils.asNumber(level),
      toc: this.toAstProperty(PropertyConfigKey._toc, toc),
      progress: this.toAstProperty(PropertyConfigKey._progress, progress),
      anchor,
      reference,
      referenceEnd,
      markConfig,
  ...
  private setDefaultBitValues(bit: Bit) {
    ...
    switch (bit.bitType.alias) {
      ...
      case AliasBitType.summaryAi:
        bit.aiGenerated = this.toAstProperty(PropertyConfigKey._aiGenerated, true);
        break;
    }
  }
