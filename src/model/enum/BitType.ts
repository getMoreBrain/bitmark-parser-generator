...
const RootBitTypeToAliasMap = {
  ...
  [RootBitType.image]: [
    //
    AliasBitType.appCreateBitsFromImage,
    AliasBitType.appGetScreenshot,
    AliasBitType.detailsImage,
    AliasBitType.figure,
    AliasBitType.imageBanner,
    AliasBitType.imageFigure,
    AliasBitType.imageLandscape,
    AliasBitType.imageMood,
    AliasBitType.imagePortrait,
    AliasBitType.imagePrototype,
    AliasBitType.imageScreenshot,
    AliasBitType.imageStyled,
    AliasBitType.imageSuperWide,
    AliasBitType.imageZoom,
    AliasBitType.langLifeSkillIcon,
    AliasBitType.lifeSkillSticker,
    AliasBitType.screenshot,
  ],
