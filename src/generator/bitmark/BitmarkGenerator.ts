...
class BitmarkGenerator extends AstWalkerGenerator<BitmarkAst, void> {
  ...
  private tagTextFormat: TextFormatType = TextFormat.bitmarkMinusMinus;
  ...
  protected enter_lead(node: NodeInfo, route: NodeInfo[]): boolean {
    ...
    this.writeNL_IfNotChain(route);
    this.writeOPC();
    this.writeTextOrValue(parent?.value?.item ?? '', this.tagTextFormat, TextLocation.tag);
    this.writeCL();
    this.writeOPC();
  ...
  protected enter_pageNumber(node: NodeInfo, route: NodeInfo[]): boolean {
    ...
    this.writeCL();
    this.writeOPC();
    this.writeTextOrValue(parent?.value?.lead ?? '', this.tagTextFormat, TextLocation.tag);
    this.writeCL();
    this.writeOPC();
    this.writeTextOrValue(pageNumber ?? '', this.tagTextFormat, TextLocation.tag);
    this.writeCL();
  ...
  protected enter_marginNumber(node: NodeInfo, route: NodeInfo[]): boolean {
    ...
    this.writeCL();
    this.writeOPC();
    this.writeTextOrValue(parent?.value?.pageNumber ?? '', this.tagTextFormat, TextLocation.tag);
    this.writeCL();
    this.writeOPC();
