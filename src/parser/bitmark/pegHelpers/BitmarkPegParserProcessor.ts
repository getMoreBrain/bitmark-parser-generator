 ...
 *   and in BitmarkPegParserBuilder.ts
 *
 */
...
class BitmarkPegParserProcessor {
  ...
  processTextFormat(value: unknown): BitContent {
  ...
  processResourceType(value: unknown): BitContent {
  ...
  processBitContent(value: unknown): BitContent[] {
  ...
  processStandardTagsChain(value: unknown): BitContent[] {
    if (DEBUG_TRACE_STANDARD_TAGS_CHAIN) this.debugPrint('StandardTagsChain', value);
    return this.reduceToArrayOfTypes(value);
  }

  processBitTag(value: BitContent): BitContent {
  ...
  processCardSet(value: unknown): BitContent {
  ...
  processCards(value: unknown): unknown {
    // console.log('Cards');
    return value;
  }
  ...
  processCardContent(value: unknown): unknown {
    if (DEBUG_TRACE_CARD_CONTENT) this.debugPrint('CardContent', value);

    return value;
  }

  processCardTags(value: unknown): unknown {
  ...
  processResourceTagsChain(resourceValue: any, extraProps: any[]) {
  ...
  processReourceTag(key: string, value: unknown): BitContent {
  ...
  processReourcePropertyTag(key: string, value: unknown): BitContent {
  ...
  processGapChainTags(value: unknown): BitContent {
  ...
  processTrueFalseChainTags(value: unknown): BitContent {
  ...
  processTag(type: TypeKeyType, value: unknown): BitContent {
  ...
  processPropertyTag(key: string, value: unknown): BitContent {
