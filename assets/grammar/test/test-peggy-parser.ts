...
function peg$parse(input: string, options?: ParseOptions) {
  ...
  const peg$startRuleFunctions: {[id: string]: any} = { test: peg$parsetest };
  let peg$startRuleFunction: () => any = peg$parsetest;

  const peg$c0 = function(bit: any): any { return bit };
  const peg$c1 = function(bitHeader: any, bitContent: any): any { return buildBit(bitHeader, bitContent) };
  const peg$c2 = "[.";
  const peg$c3 = peg$literalExpectation("[.", false);
  const peg$c4 = "]";
  const peg$c5 = peg$literalExpectation("]", false);
  const peg$c6 = function(bitType: any, formatAndResource: any): any { return buildBitHeader(bitType, formatAndResource) };
  const peg$c7 = function(value1: any, value2: any): any { return buildTextAndResourceType(value1, value2) };
  const peg$c8 = ":";
  const peg$c9 = peg$literalExpectation(":", false);
  const peg$c10 = function(value: any): any { return { type: TypeKey.TextFormat, value } };
  const peg$c11 = "&";
  const peg$c12 = peg$literalExpectation("&", false);
  const peg$c13 = function(value: any): any { return { type: TypeKey.ResourceType, value } };
  const peg$c14 = function(value: any): any { return value };
  const peg$c15 = function(value: any): any { return { type: TypeKey.BodyLine, value: value } };
  const peg$c16 = "===";
  const peg$c17 = peg$literalExpectation("===", false);
  const peg$c18 = function(value: any): any { return { type: TypeKey.CardSet, value: value } };
  const peg$c19 = "[@";
  const peg$c20 = peg$literalExpectation("[@", false);
  const peg$c21 = function(key: any, value: any): any { return { type: TypeKey.Property, key, value } };
  const peg$c22 = "[%";
  const peg$c23 = peg$literalExpectation("[%", false);
  const peg$c24 = function(value: any): any { return { type: TypeKey.ItemLead, value } };
  const peg$c25 = "[!";
  const peg$c26 = peg$literalExpectation("[!", false);
  const peg$c27 = function(value: any): any { return { type: TypeKey.Instruction, value } };
  const peg$c28 = "[?";
  const peg$c29 = peg$literalExpectation("[?", false);
  const peg$c30 = function(value: any): any { return { type: TypeKey.Hint, value } };
  const peg$c31 = /^[^\]]/;
