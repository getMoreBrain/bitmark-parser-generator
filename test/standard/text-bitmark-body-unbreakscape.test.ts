...
import { getTestFiles, getTestFilesDir } from './config/config-text-bitmark-body-breakscape-files';
...
const TEST_OUTPUT_DIR = path.resolve(__dirname, './results/text-bitmark-body-unbreakscape/output');
...
describe('text-bitmark-body-unbreakscape', () => {
  describe('Breakscaped Text (bitmark, body) => Text', () => {
