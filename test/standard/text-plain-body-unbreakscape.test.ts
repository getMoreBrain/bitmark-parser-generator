...
const TEST_OUTPUT_DIR = path.resolve(__dirname, './results/text-plain-body-unbreakscape/output');
...
describe('text-plain-body-unbreakscape', () => {
  describe('Breakscaped Text (plain, body) => Text', () => {
