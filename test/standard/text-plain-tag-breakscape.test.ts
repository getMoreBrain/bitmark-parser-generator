...
import { getTestFiles, getTestFilesDir } from './config/config-text-plain-tag-breakscape-files';
...
const TEST_OUTPUT_DIR = path.resolve(__dirname, './results/text-plain-tag-breakscape/output');
...
describe('text-plain-tag-breakscape', () => {
  describe('Text => Breakscaped Text (plain, tag)', () => {
