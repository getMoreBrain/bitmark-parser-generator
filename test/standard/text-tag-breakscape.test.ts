...
import { getTestFiles, getTestFilesDir } from './config/config-text-tag-files';
...
const TEST_OUTPUT_DIR = path.resolve(__dirname, './results/text-tag-breakscape/output');
...
describe('text-tag-breakscape', () => {
  describe('Text => Breakscaped Text: Tests', () => {
