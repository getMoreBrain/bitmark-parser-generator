...
const TEST_OUTPUT_DIR = path.resolve(__dirname, './results/text-bitmark-body-breakscape/output');
...
describe('text-bitmark-body-breakscape', () => {
  describe('Text => Breakscaped Text (bitmark, body)', () => {
