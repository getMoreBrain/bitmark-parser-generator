module.exports = {
  ...
  rootDir: '../../../..',
  roots: ['<rootDir>/src', '<rootDir>/test/custom/parser/books'],
  ...
  reporters: [
    'default',
    [require.resolve('jest-junit'), { outputDirectory: '<rootDir>/test/custom/parser/books/results' }],
    [
      require.resolve('jest-html-reporter'),
      {
        outputPath: '<rootDir>/test/custom/parser/books/results/test-report.html',
